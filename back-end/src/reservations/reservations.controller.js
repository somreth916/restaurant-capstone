...
// Checks the date to make sure the date selected is within restaurant hours
...
// Makes sure the object body has all required information
...
// Checks if reservation ID is provided
